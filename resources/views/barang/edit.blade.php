                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="sumber_dana" id="sumber_dana" class="form-control @error('sumber_dana') is-invalid @enderror">
                                        ...
                                        <option value="BOS" {{ $barang->sumber_dana == 'BOS' ? 'selected' : '' }}>Dana BOS</option>
                                        <option value="BOSDA" {{ $barang->sumber_dana == 'BOSDA' ? 'selected' : '' }}>Dana BOSDA</option>
                                        <option value="KOMITE" {{ $barang->sumber_dana == 'KOMITE' ? 'selected' : '' }}>KOMITE</option>
                                        <option value="LAINNYA" {{ $barang->sumber_dana == 'LAINNYA' ? 'selected' : '' }}>Lainnya</option>
                                    </select>
                                    @error('sumber_dana')
                                        <span class="error invalid-feedback">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="harga_perolehan" class="form-control @error('harga_perolehan') is-invalid @enderror"
                                        id="harga_perolehan" placeholder="0" value="{{ $barang->harga_perolehan }}">
